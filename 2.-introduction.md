...
Ex: **GBM, GLM, DRF, XGBoost, etc**. While the model-agnostic will be the methods that are used to interpret models, ex: **Variable importance, Partial Dependacy Plot, ICE plot**.
