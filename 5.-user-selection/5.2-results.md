...
The sum of the AVG is 0.75. Thus, the score for the Interpretatble Models\(Model-Specific\) is **0.75**

**Similary, the rest of the methods have been scored and ploted to provide the Overall Score Chart**
